...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("ProyectoHotel");
    ...
    private SideNav createNavigation() {
        ...
        nav.addItem(new SideNavItem("Habitacion", HabitacionView.class, LineAwesomeIcon.COLUMNS_SOLID.create()));
        nav.addItem(new SideNavItem("Reserva", ReservaView.class, LineAwesomeIcon.HOTEL_SOLID.create()));
